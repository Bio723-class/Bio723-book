...
We'll start by illustrating bivariate regression with the [lion nose pigmentation data set](https://github.com/Bio723-class/example-datasets/raw/master/ABD-lion-noses.csv) introduced in the in-class assignment last week. Let's load the lion data and remind ourselves of the basic structure:
